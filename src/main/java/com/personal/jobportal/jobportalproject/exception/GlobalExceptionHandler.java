package com.personal.jobportal.jobportalproject.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, Object>> handleAllExceptions(Exception ex, HttpServletRequest request) {
        ...
        message.put("Error", ex.getMessage());  // Use a generic message for uncaught exceptions
    ...
    @ExceptionHandler(value = {EmployerRoleException.class})
    public ResponseEntity<Map<String, Object>> handleEmployerRoleException(EmployerRoleException ex) {
        Map<String, Object> message = new HashMap<>();
    ...
    public ResponseEntity<Map<String, Object>> handleUsernameNotFoundException(UsernameNotFoundException ex) {
        Map<String, Object> message = new HashMap<>();
        message.put("Error", "Invalid credentials (username not found)");
